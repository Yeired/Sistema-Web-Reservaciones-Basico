...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2023 a las 09:30:55
...
(6, 7, 'juancho', 'Gallegos', 5565053082, 'eric.isael20@gmail.com');
...
INSERT INTO `reservaciones` (`id_reservacion`, `id_cliente`, `ficha`, `fecha`, `hora`, `tipo_paquete`, `cantidad_personas`, `informacion_extra`) VALUES
...
(7, 6, '', '2023-08-01', '10:00:00', 1, 1, ''),
(8, 6, '', '2023-08-01', '10:00:00', 1, 1, ''),
(9, 6, 'GSnDGrLvNm', '2023-06-30', '23:07:00', 2, 1, '');
...
(7, 'eric', '$2y$10$fPYY9blKk6PTjTa1qeWK4ud0zTiBzZ0IF3VANNBJ8mZvOtTFRS3jW');
...
--
ALTER TABLE `reservaciones`
  MODIFY `id_reservacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
